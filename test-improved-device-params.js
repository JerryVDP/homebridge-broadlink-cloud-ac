...
async function testDeviceParams() {
    ...
    // Initialize API
    const api = new AuxCloudAPI('usa'); // or 'us' based on your region
    ...
    try {
        ...
        for (let i = 0; i < allDevices.length; i++) {
            ...
            try {
                ...
                const modeParams = await api.getDeviceParams(device, ['pwr', 'mode']);
                ...
                // Test with multiple specific parameters
                console.log('\n🔍 Testing multiple specific parameters...');
